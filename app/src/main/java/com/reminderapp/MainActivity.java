...
public class MainActivity extends AppCompatActivity {
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public void onBindViewHolder(VerticalItemHolder itemHolder, int position) {
            ...
            itemHolder.mDateAndTimeText.setText(item.mDateTime);
            itemHolder.setReminderTitle(item.mTitle);
            itemHolder.description.setText(item.mDescription);
            itemHolder.beforeText.setText(item.mBeforeTime);
            itemHolder.withText.setText(item.mWithText);
        ...
        public class ReminderItem {
            ...
            public ReminderItem(String Title, String DateTime, String Active,String des,String brfTime,String with) {
                this.mTitle = Title;
                this.mDateTime = DateTime;
                this.mActive = Active;
                this.mDescription =des;
                this.mBeforeTime =brfTime;
                this.mWithText=with;
            }
        }
        ...
        public class VerticalItemHolder extends SwappingHolder
            ...
            private SimpleAdapter mAdapter;
            private TextView description, beforeText, withText;
            ...
            public VerticalItemHolder(View itemView, SimpleAdapter adapter) {
                ...
                description = (TextView) itemView.findViewById(R.id.recycle_description);
                beforeText = (TextView) itemView.findViewById(R.id.recycle_beforeTime);
                withText = (TextView) itemView.findViewById(R.id.recycle_withText);
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            List<String> beforList = new ArrayList<>();
            ...
            for (Reminder r : reminders) {
                ...
                descriptionList.add(r.getmDescription());
                beforList.add(r.getmBeforeTime());
                withList.add(r.getmWithText());
                IDList.add(r.getID());
            }
            ...
            for (DateTimeSorter item : DateTimeSortList) {
                ...
                items.add(new SimpleAdapter.ReminderItem(Titles.get(i), DateAndTime.get(i), Actives.get(i),descriptionList.get(i),beforList.get(i),withList.get(i)));
